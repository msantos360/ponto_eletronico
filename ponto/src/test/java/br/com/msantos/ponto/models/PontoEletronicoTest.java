...
public class PontoEletronicoTest {
	...
	public void pontoEletronicoComPontoEletronicoBuider() {
		...
		PontoEletronico pauloBuider = new PontoEletronicoBuilder()
				.comFuncionario(paulo)
				.comInicioJornada(22, 07, 2019, 8, 0)
				.comInicioIntervalo(22, 07, 2019, 12, 0)
				.comTerminoIntervalo(22, 07, 2019, 13, 0)
				.comTerminoJornada(22, 07, 2019, 18, 0).buider();
	...
	public void funcionarioEntrouAtrasadoEmRelacaoAoSeuHorario() {
		PontoEletronico pontoPaulo = new PontoEletronicoBuilder()
			.comFuncionario(paulo)
			.comInicioJornada(22, 07, 2019, 8, 15)
			.comInicioIntervalo(22, 07, 2019, 12, 0)
			.comTerminoIntervalo(22, 07, 2019, 13, 0)
			.comTerminoJornada(22, 07, 2019, 18, 0).buider();
	...
	public void fezMaisTempoQueOpermitidoDeIntervalo() {
		PontoEletronico pontoPaulo = new PontoEletronicoBuilder()
				.comFuncionario(paulo)
				.comInicioJornada(22, 07, 2019, 8, 00)
				.comInicioIntervalo(22, 07, 2019, 12, 00)
				.comTerminoIntervalo(22, 07, 2019, 13, 30)
				.comTerminoJornada(22, 07, 2019, 18, 00).buider();
	...
	public void saiuMaisCedoQueOterminoDaJornadaEstipulado() {
		...
		PontoEletronico pontoPaulo = new PontoEletronicoBuilder()
				...
				.comInicioJornada(22, 07, 2019, 8, 00)
				.comInicioIntervalo(22, 07, 2019, 12, 00)
				.comTerminoIntervalo(22, 07, 2019, 13, 00)
				.comTerminoJornada(22, 07, 2019, 16, 30).buider();
	...
	public void fezAdicionalNoturno() {
		...
		PontoEletronico pontoPaulo = new PontoEletronicoBuilder()
				...
				.comInicioIntervalo(22, 07, 2019, 12, 00)
				.comTerminoIntervalo(22, 07, 2019, 13, 00)
				.comTerminoJornada(22, 07, 2019, 22, 00).buider();
	...
	public void naoFezAdicionalNoturno() {
		...
		PontoEletronico pontoPaulo = new PontoEletronicoBuilder()
				...
				.comInicioIntervalo(22, 07, 2019, 12, 00)
				.comTerminoIntervalo(22, 07, 2019, 13, 00)
				.comTerminoJornada(22, 07, 2019, 21, 00).buider();
	...
	public void deveGarantirIntervaloEntreDias() {
		...
		PontoEletronico pontoPaulo = new PontoEletronicoBuilder()
				.comFuncionario(paulo)
				.comInicioJornada(22, 07, 2019, 20, 00)
				.comInicioIntervalo(22, 07, 2019, 23, 30)
				.comTerminoIntervalo(23, 07, 2019, 00, 30)
				.comTerminoJornada(23, 07, 2019, 6, 00).buider();
	...
	public void fezMaisQue12horasDeTrabalho() {
		PontoEletronico pontoPaulo = new PontoEletronicoBuilder()
				...
				.comInicioIntervalo(22, 07, 2019, 23, 30)
				.comTerminoIntervalo(23, 07, 2019, 00, 30)
				.comTerminoJornada(23, 07, 2019, 9, 00).buider();
	...
	public void validaEntradasESaidasDoFuncionarioComEstado() {
		...
		PontoEletronico pontoPauloComEstado = new PontoEletronicoBuilder()
				.comFuncionario(paulo).buider();
